...
/**********************************************************************
 ...
 This code base contains driver and library code to accompany our book on Quantum Mechanics.
 ...
 Mark Everitt, 21 Feb 2023
 */

/*
 TODO: Uncomment the function you wish to run.
 
 TODO: Edit or create paths to write data files
 Each Driver assumes a path to a directory structure relative to
 their home directory that the user should either edit or create
 */

// coverImage()
// Chapter02_DuffingOscillatorPDF()
// Chapter04_WignerFunctionPlot()
// Chapter04_SpinWignerFunctionPlot()

// Main driver referred to in the coding chapter
Chapter08_JaynesCummingsModel()

// chapter08Wigner()
//
// NB: this may only run on hardware where the LAPACK/accelerate framework is used.
// Chapter10_computeExampleSQUIDEigenvalues()

// A collection of functions associated with chapter 11

// DuffingQSD()                          // was too slow to be useful for small beta
// DuffingQSD_with_moving_basis()        // still not fast enough for beta=0.01
// DuffingQSD_with_moving_basis_sparse() // just good enough to run in background - takes a long time still
...
/***************************************
  ...
  Created by M J Everitt on 19/08/2021.
